 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	{title: `⚡) Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 NexBotz..."},
	]
    },{
	...
	rows: [
	    {title: `⫹🗒️ › -〚 All Menu 〛-𐑂`, rowId: ".? all", description: "╰► Waduhh. Langsung semuanya (≧▽≦)"},
	...
	{title: `⫹🎵 › -〚 Audio 〛-𐑂`, rowId: ".? audio", description: "╰► Calon remixer nih haha ></"},
        {title: `⫹🎶 › -〚 Sound 〛-𐑂`, rowId: ".soundmenu", description: "╰► dengerin lagu nih haha ></"},
	...
	{title: `⫹👩‍💻 › -〚 Owner 〛-𐑂`, rowId: ".? owner", description: "╰► Yg bukan developer gausah nge klik fitur ini !"},
...
const listMessage = {
  text: tek,
  footer: '*🐋Note:Jangan spam command saat menggunakan bot* ',
