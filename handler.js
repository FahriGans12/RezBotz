...
esteh: 0,
    ...
    return new Promise(async(resolve, reject) => {
        ...
        resolve(ab)
          ...
          global.kontak2 = [
        ['6283811034750', 'RezBotz', 'Creator Bot', 'Creator Bot', true],
        ...
        for (let name in global.plugins) {
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                if (plugin.level > _user.level) {
                    this.sendButton(m.chat, `[🐋] Diperlukan level *${plugin.level}* untuk menggunakan perintah ini*${plugin.level}* level is required to use this command`, author, null,[['Ok', 'ok']] , m)
